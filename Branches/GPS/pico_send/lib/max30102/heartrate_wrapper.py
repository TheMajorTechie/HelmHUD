...
from lib.max30102 import MAX30102, MAX30105_PULSE_AMP_MEDIUM, MAX30105_PULSE_AMP_LOWEST, MAX30105_PULSE_AMP_HIGH
...
class heartrate:
    ...
    def __init__(self, i2c):
        ...
        sensor = MAX30102(i2c)
        sensor.setup_sensor()
        sensor.set_sample_rate(400) #400 samples taken per second (2500us)
        sensor.set_fifo_average(8)

        sensor.set_active_leds_amplitude(MAX30105_PULSE_AMP_MEDIUM)
        sensor.shutdown()
        buffer = collections.deque((), 400) #double-ended queue with max size of 400
